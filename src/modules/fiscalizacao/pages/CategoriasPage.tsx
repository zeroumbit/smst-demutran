    ...
    <div className="space-y-6">
      {scope === 'admin' && (
        <div className="sticky top-0 z-20 flex items-center gap-1 border-b border-slate-200/80 bg-white/95 px-1 py-2 backdrop-blur-md lg:hidden">
          ...
          <h1 className="truncate text-lg font-bold tracking-tight text-slate-900">Navegação por categorias</h1>
        </div>
      )}
      {scope === 'guarda' && (
      ...
      <section className="hidden rounded-[24px] bg-[linear-gradient(140deg,_#111827_0%,_#1d4ed8_50%,_#14b8a6_100%)] px-4 py-5 text-white md:rounded-[30px] md:px-6 md:py-6 lg:block">
