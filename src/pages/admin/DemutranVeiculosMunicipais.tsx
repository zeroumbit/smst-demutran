...
import { ArrowLeft, Building2, Calendar, CarFront, CheckCircle, Clock, Download, Eye, FileSpreadsheet, IdCard, Search, ShieldCheck, SlidersHorizontal, Upload, User, X } from 'lucide-react';
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-1 lg:hidden px-1 py-2">
          ...
          <h1 className="truncate text-lg font-bold tracking-tight text-slate-900">Frota Municipal</h1>
        </div>
