    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-1 lg:hidden px-1 py-2">
          ...
          <h1 className="truncate text-lg font-bold tracking-tight text-slate-900">Credenciais</h1>
        </div>
          ...
          <div className="space-y-4 px-4 pb-4 pt-5 md:space-y-6 md:px-6 md:pb-5 md:pt-6">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <h1 className="mt-2 text-xl font-black tracking-[-0.05em] text-white sm:text-2xl md:mt-3 md:text-[32px] md:tracking-[-0.07em] lg:text-[38px]">Credenciais</h1>
