-- Fix recolher_veiculo save: local_custodia must match demutran_local_custodia enum.
-- Keep the detailed seizure parameters used by the admin form.
DO $$
DECLARE
  r RECORD;
BEGIN
...
GRANT EXECUTE ON FUNCTION public.recolher_veiculo(
  ...
  timestamptz, text, text, public.demutran_local_custodia, text, text, text, text, text, text, text
) TO authenticated;
