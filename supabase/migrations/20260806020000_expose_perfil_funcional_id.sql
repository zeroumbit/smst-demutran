-- =====================================================
-- Permissions V2 - Expor perfil_funcional_id no profile
-- Fase 3.0. Nao altera comportamento (flag ainda off).
-- Reversivel: recrear get_user_profile() da 20260728000002
-- =====================================================
