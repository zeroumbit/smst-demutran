-- Fix provision_admin_user: remove INSERT into non-existent perfis_usuarios_modulos table.
-- Modulos are stored only in auth.users.raw_app_meta_data (as the original code does).
