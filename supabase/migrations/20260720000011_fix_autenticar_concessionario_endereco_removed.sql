-- Corrige autenticar_concessionario apos remocao da coluna endereco.
-- A tabela usa logradouro/numero/bairro_distrito, mas a RPC antiga ainda
-- acessava v_concessionario.endereco e quebrava o login com erro 42703.
