-- Fix recolher_veiculo function: _local_custodia parameter must match the enum type
-- Previously defined as 'text', causing: column "local_custodia" is of type demutran_local_custodia but expression is of type text
