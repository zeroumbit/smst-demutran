-- Add JGC profile info to get_user_profile so AdminLayout can filter menus synchronously
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'jgc_perfil', jgc_perfil_val,
    'jgc_area_atuacao', jgc_area_val
  );
END;
$$;
